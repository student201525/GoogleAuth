...
namespace WebApplication5
{
        ...
        public void Configuration(IAppBuilder app)
        {
           ...
           // app.CreatePerOwinContext<AppRoleManager>(AppRoleManager.Create);
            ...
            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions
            {
                ...
                ClientId = "981660473645-c5fbqurquppafnbtghhhr50uhtrb8hrf.apps.googleusercontent.com",
                ClientSecret = "c3BfqatKUvRNVbMSkIPUS_D4",
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        internal Task<IdentityResult> CreateAsync(AppUser user)
        {
            throw new NotImplementedException();
        }

        internal Task<ClaimsIdentity> CreateIdentityAsync(AppUser user, string applicationCookie)
        {
            throw new NotImplementedException();
        }
    }
